...
const imageSchema = new Schema({ url: { type: String, required: true }, alt: { type: String } }, { _id: false });
...
// Images as objects allows future metadata (alt, order, provider)
...
// Compound index for farmer + status queries
